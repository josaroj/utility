...
async function handler(req, res) {
    if (req.method === "PUT") {
        ...
        if (verifiedToken && verifiedToken.role === "admin") {
            ...
            const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("UPDATE meterdata SET userid = ?, meterelec = ?, meterwater = ?, meteraircomp1 = ?, meteraircomp2 =? WHERE id = ?", [
                userid,
                meterelec,
                meterwater,
                meteraircomp1,
...
var __webpack_exports__ = __webpack_require__.X(0, [808], () => (__webpack_exec__(179)));
