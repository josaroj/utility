...
async function handler(req, res) {
    if (req.method === "GET") {
        ...
        if (verifiedToken && verifiedToken.role === "admin") {
            ...
            const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("SELECT * FROM meterdata WHERE date = ?", [
                reqdate
            ]);
            //console.log(results);
...
var __webpack_exports__ = __webpack_require__.X(0, [808], () => (__webpack_exec__(255)));
