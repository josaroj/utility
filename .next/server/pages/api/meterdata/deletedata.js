...
async function handler(req, res) {
    if (req.method === "DELETE") {
        ...
        if (verifiedToken && verifiedToken.role === "admin") {
            ...
            const { id  } = req.body;
            const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("DELETE FROM meterdata WHERE id = ?", [
                id
            ]);
            //console.log(results);
...
var __webpack_exports__ = __webpack_require__.X(0, [808], () => (__webpack_exec__(445)));
